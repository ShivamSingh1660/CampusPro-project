    ...
    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="space-y-2">
          <Label htmlFor="email">Email / College Email</Label>
          <Input 
            id="email" 
            type="email" 
      ...
      <div className="mt-6 flex items-center justify-center gap-2 text-sm text-muted-foreground">
        ...
        <Link href="/signup" className="font-semibold text-primary hover:underline hover:underline-offset-4">
          Create account
        </Link>
      </div>
      ...
      <Button variant="outline" type="button" className="w-full h-11" disabled={isLoading} onClick={() => toast.info("Google OAuth will be implemented soon.")}>
